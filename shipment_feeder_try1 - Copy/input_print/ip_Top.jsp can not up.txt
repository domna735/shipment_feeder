...
out.println("<script language=\"JavaScript\" type=\"text/javascript\" src=\"../js/feed_print2/fp_Top.js\" head=\"DHL Waybill Printing\" logo=\"" + session.getAttribute("logo_filename") + "\" cname=\"" + session.getAttribute("contact_name") + "\"></script>");
